   ...
   <div class="box box-info">
        ...
        <div class="box-body">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                <input type="text" class="form-control" id="teamname" name="team_name" placeholder="Enter Team Name">
                </div>
            </div>
            <div class="form-group">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="inputPassword3" class="col-sm-4 control-label">Select Teamleader</label>
                            <div class="col-sm-8">
...
$(document).on('click','.deactive',function(){
    ...
    $.get('updateteamstatus/'+id+'/'+teamid,function(data){
      toastr.options = {
          ...
          setTimeout(function() {toastr.success('Team was deactivated');}, 1000);
  })
})
$(document).on('click','.active',function(){
    ...
    $.get('updateteamstatus/'+id+'/'+teamid,function(data){
      toastr.options = {
          ...
          setTimeout(function() {toastr.success('Team was activated');}, 1000);
  })
})
</script>
@endsection
