...
<head>
  ...
  <title>Weaver Innovations | Log in</title>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="{{asset('themeasset/plugins/iCheck/square/blue.css')}}">
...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Weaver Innovations</a>
  </div>
  <!-- /.login-logo -->
